...
const about = {
  ...
  imageSize: 300,
  message:
    "Hello! I am Erica. I'm an enthusiastic, responsible and hard working developer. Being worked for different projects helped me to adopt to the changes quickly. My goal is to pursue my passion within the field of software engineering.",
};
